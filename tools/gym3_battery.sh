...
PRESSURE="1:bots/mimic_t1.py 1:bots/mimic_t15.py 1:bots/sluggish.py 1:bots/hungry_shy.py"
...

{
  ...
  python3 tools/gym3_batteryparse.py elite champion \
    "elite,elite,champion,champion,mimic_t1,mimic_t15,sluggish,hungry_shy::$PRES/A/ws*" \
    "champion,champion,elite,elite,mimic_t1,mimic_t15,sluggish,hungry_shy::$PRES/B/ws*"
  echo
