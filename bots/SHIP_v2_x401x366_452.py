...
CONFIG = {
    ...
    "VIRUS_FEAST_FALLOFF": 0.819445,   # feast attraction falloff exponent (was 1/d)
    ...
    "VIRUS_SLOT_EXP": 0.2415,        # 0=off; feast force *= (blobs/16)^exp
    ...
    "ARCH_N0_ON": 1,
    "ARCH_N0_OP": 10,
    "ARCH_N0_A": 4,       # late_phase
    "ARCH_N0_B": 5,        # prey_opportunity
    "ARCH_N0_K": 2.22486,
    "ARCH_N0_BIAS": -1.11893,
    "ARCH_N0_TARGET": 4,   # prey channel logit
    "ARCH_N0_GAIN": -0.212052,

    "ARCH_N1_ON": 1,
    "ARCH_N1_OP": 3,
    "ARCH_N1_A": 19,        # threat_pressure
    "ARCH_N1_B": 3,        # wealth
    "ARCH_N1_K": 4.37881,
    "ARCH_N1_BIAS": -0.873349,
