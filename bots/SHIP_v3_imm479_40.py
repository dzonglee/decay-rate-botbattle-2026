...
CONFIG = {
    ...
    "CYCLE_THREAT_CLEAR": 14.1896,   # only cycle when threats are FAR (avoid deaths-while-fragmented); bounds (2,30)
    ...
    "CAMP_MAX_MASS": 68.1447,        # too rich to camp (banking dominates)
    ...
    "ARCH_N0_K": 0.334384,
    "ARCH_N0_BIAS": -0.982727,
    "ARCH_N0_TARGET": 6,   # prey channel logit
    "ARCH_N0_GAIN": -1.46118,
