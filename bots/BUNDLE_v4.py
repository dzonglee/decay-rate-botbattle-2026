...
CONFIG = {
    ...
    "W_KG_FEAR": 3,              # repulsion from unseen-eater kill sites
    "KG_DECAY_TICKS": 25,          # ping lifetime (rounds)
    "KG_MIN_VICTIM": 2,          # ignore kills of dust (victim mass floor)
    ...
    "CYCLE_MIN_MASS": 37.968,       # only cycle once BIG (don't fragment a small bank); bounds (4,40)
    ...
    "VIRUS_FEAST_FALLOFF": 0.205124,   # feast attraction falloff exponent (was 1/d)
    "CYCLE_TARGET_BLOBS": 4,   # cycle split ceiling (was 16)
    # ORGAN: corner-siege fix (uncatchable corner-tucked prey -> zero force)
    "CORNER_SKIP_ON": 0.535739,        # >0.5 on; bounds (0,1). Hard-ON fleet-wide 2026-07-13:
    ...
    "CORNER_VETO_TICKS": 16.9589,       # sticky veto: uncatchable corner target is blacklisted
    ...
    "WEALTH_START": 34.4101,         # own total mass where wealth fear begins
    ...
    "CAMP_MAX_MASS": 101.295,        # too rich to camp (banking dominates)
    ...
    "VULN_EAT_MARGIN": 1.1,       # post-split half must out-mass target*EAT_RATIO*this
    ...
    "VULN_MAX_BANK_RISK": 57.357,    # never fire while wealthy (bank is the score)
    ...
    "ARCH_ON": 1,
    "ARCH_AUTHORITY": 0.395225,       # graph share of final steering; evolve in [0.35, 1.0]
    "ARCH_MIN_AUTHORITY": 0.35,   # prevents selection solving architecture by silencing it
    "ARCH_SPLIT_THRESHOLD": 1.2,
    ...
    "ARCH_N1_B": 3,        # wealth
    "ARCH_N1_K": 1.91596,
    "ARCH_N1_BIAS": 1.52255,
    "ARCH_N1_TARGET": 4,   # escape channel logit
    "ARCH_N1_GAIN": 0.632399,
    ...
    "ARCH_N4_B": 17,
    "ARCH_N4_K": 3.37956,
    "ARCH_N4_BIAS": 0.376459,
    "ARCH_N4_TARGET": 5,
    "ARCH_N4_GAIN": -0.774174,
    ...
    "ARCH_N8_B": 19,
    "ARCH_N8_K": 3.02227,
    "ARCH_N8_BIAS": 1.56775,
    "ARCH_N8_TARGET": 9,
    "ARCH_N8_GAIN": -0.0197587,
    ...
    "ARCH_N9_B": 19,
    "ARCH_N9_K": 3.49372,
    "ARCH_N9_BIAS": -0.429092,
    "ARCH_N9_TARGET": 9,
    "ARCH_N9_GAIN": -1.19204,

    "ARCH_N10_ON": 0.742805,
    "ARCH_N10_OP": 6,
    "ARCH_N10_A": 12,
    "ARCH_N10_B": 19,
    "ARCH_N10_K": 5.09619,
    "ARCH_N10_BIAS": 1.89576,
    "ARCH_N10_TARGET": 3,
    "ARCH_N10_GAIN": 0.872468,
    "ARCH_N11_ON": 0.637183,
    "ARCH_N11_OP": 0,
    "ARCH_N11_A": 28,
    "ARCH_N11_B": 6,
    "ARCH_N11_K": 3.92072,
    "ARCH_N11_BIAS": 0.359483,
    "ARCH_N11_TARGET": 13,
    "ARCH_N11_GAIN": -1.5,
    "ARCH_N12_ON": 0,
    "ARCH_N12_OP": 3,
    ...
    "ARCH_N12_B": 14,
    "ARCH_N12_K": 6,
    "ARCH_N12_BIAS": 1.13246,
    "ARCH_N12_TARGET": 10,
    "ARCH_N12_GAIN": 0.391746,
    "ARCH_N13_ON": 1,
    "ARCH_N13_OP": 3,
    "ARCH_N13_A": 15,
    "ARCH_N13_B": 9,
    "ARCH_N13_K": 1.42675,
    "ARCH_N13_BIAS": 0.433642,
    "ARCH_N13_TARGET": 6,
    "ARCH_N13_GAIN": 0.55643,
    "ARCH_N14_ON": 1,
    "ARCH_N14_OP": 0,
    "ARCH_N14_A": 14,
    "ARCH_N14_B": 0,
    "ARCH_N14_K": 1.9208,
    "ARCH_N14_BIAS": -1.71467,
    "ARCH_N14_TARGET": 7,
    "ARCH_N14_GAIN": 1.5,
    "ARCH_N15_ON": 0.668014,
    "ARCH_N15_OP": 4,
    "ARCH_N15_A": 3,
    "ARCH_N15_B": 0,
    "ARCH_N15_K": 1.2895,
    ...
    if CONFIG["KG_ON"] > 0.5 or CONFIG["RC_ON"] > 0.5:
        ...
        if CONFIG["KG_ON"] > 0.5 and tracker.kg_pings:
            ...
            for _r0, _px, _py, _vm in tracker.kg_pings:
                _implied = _vm * 1.44          # eat rule: eater radius >= ~1.2x victim
...
MODE_OVERLAYS = {0: {'LA_HORIZON': 2.0, 'LA_VIRUS': 0.950424, 'VIRUS_FEAST_CLEAR': 7.962384, 'FEAST_MIN_MASS': 4, 'W_VIRUS_FEAST': 2.5, 'CYCLE_MIN_MASS': 44.163657, 'VIRUS_FEAST_FALLOFF': 0.2, 'CYCLE_TARGET_BLOBS': 9.120591, 'CORNER_SKIP_ON': 0.899687, 'CORNER_TUCK': 0.579234, 'CORNER_VETO_TICKS': 28.28115, 'W_FRAG_HUNT': 0.000475, 'WEALTH_START': 40, 'CAMP_MAX_MASS': 148.001511, 'VULN_EAT_MARGIN': 1.129965, 'VULN_MAX_BANK_RISK': 53.804177, 'ARCH_AUTHORITY': 0.35, 'ARCH_SPLIT_THRESHOLD': 0.452162, 'ARCH_N0_ON': 0.987313, 'ARCH_N0_OP': 4.0, 'ARCH_N0_K': 0.2, 'ARCH_N0_GAIN': 1.039648, 'ARCH_N1_ON': 0.283439, 'ARCH_N1_K': 2.008828, 'ARCH_N1_BIAS': -0.122259, 'ARCH_N1_GAIN': -0.033392, 'ARCH_N2_ON': 0.640335, 'ARCH_N2_BIAS': -2.0, 'ARCH_N2_TARGET': 6.0, 'ARCH_N2_GAIN': 0.679025, 'ARCH_N3_ON': 1, 'ARCH_N3_BIAS': -1.330251, 'ARCH_N3_GAIN': -1.5, 'ARCH_N4_ON': 1, 'ARCH_N4_A': 11.0, 'ARCH_N4_B': 19.0, 'ARCH_N4_K': 6.0, 'ARCH_N4_BIAS': -0.309839, 'ARCH_N4_GAIN': -0.622176, 'ARCH_N5_ON': 1, 'ARCH_N5_OP': 3.0, 'ARCH_N5_K': 1.02967, 'ARCH_N5_GAIN': 1.5, 'ARCH_N6_ON': 1, 'ARCH_N6_K': 5.506264, 'ARCH_N6_BIAS': 0.063091, 'ARCH_N6_GAIN': -0.651235, 'ARCH_N7_OP': 3.0, 'ARCH_N7_A': 3.0, 'ARCH_N7_K': 3.166739, 'ARCH_N7_BIAS': 1.237052, 'ARCH_N7_TARGET': 13, 'ARCH_N7_GAIN': 1.314452, 'ARCH_N8_ON': 0.499292, 'ARCH_N8_K': 1.616519, 'ARCH_N8_BIAS': -1.158239, 'ARCH_N8_GAIN': 1.5, 'ARCH_N9_ON': 0, 'ARCH_N9_K': 0.2, 'ARCH_N9_BIAS': 0.368604, 'ARCH_N9_GAIN': 1.5, 'ARCH_N10_ON': 0, 'ARCH_N10_OP': 4.0, 'ARCH_N10_K': 0.684808, 'ARCH_N10_BIAS': -1.188619, 'ARCH_N10_GAIN': -1.5, 'ARCH_N11_ON': 0.812803, 'ARCH_N11_OP': 3.0, 'ARCH_N11_K': 2.078501, 'ARCH_N11_BIAS': -0.676983, 'ARCH_N11_TARGET': 5.0, 'ARCH_N12_ON': 0.980387, 'ARCH_N12_A': 23.0, 'ARCH_N12_K': 3.243227, 'ARCH_N12_BIAS': -2.0, 'ARCH_N12_TARGET': 11.0, 'ARCH_N12_GAIN': -1.5, 'ARCH_N13_ON': 0.410537, 'ARCH_N13_A': 8.0, 'ARCH_N13_K': 3.417171, 'ARCH_N13_BIAS': -2.0, 'ARCH_N13_TARGET': 11.0, 'ARCH_N13_GAIN': -0.146441, 'ARCH_N14_ON': 0, 'ARCH_N14_A': 12.0, 'ARCH_N14_K': 6.0, 'ARCH_N14_BIAS': -0.118625, 'ARCH_N14_GAIN': 1.196612, 'ARCH_N15_ON': 0.939132, 'ARCH_N15_OP': 6.0, 'ARCH_N15_A': 25.0, 'ARCH_N15_K': 0.2, 'ARCH_N15_GAIN': -0.731979}, 1: {}, 2: {'LA_HORIZON': 3, 'LA_VIRUS': 1, 'VIRUS_FEAST_CLEAR': 1.64731, 'FEAST_MIN_MASS': 4, 'W_VIRUS_FEAST': 1.738369, 'CYCLE_MIN_MASS': 52.674563, 'CYCLE_THREAT_CLEAR': 10.184358, 'HUNTER_AVOID_MULT': 0.944314, 'VIRUS_FEAST_FALLOFF': 0.352287, 'CORNER_SKIP_ON': 1, 'CORNER_TUCK': 0.579234, 'W_FRAG_HUNT': 0.000475, 'WEALTH_START': 40, 'CAMP_MAX_MASS': 58.75392, 'VIRUS_SLOT_EXP': 0.650574, 'VULN_EAT_MARGIN': 1.129965, 'VULN_MAX_BANK_RISK': 53.804177, 'ARCH_AUTHORITY': 0.49759, 'ARCH_SPLIT_THRESHOLD': 0.54251, 'ARCH_N0_ON': 0.566941, 'ARCH_N0_K': 0.2, 'ARCH_N0_BIAS': -1.362268, 'ARCH_N0_GAIN': 0.030038, 'ARCH_N1_ON': 0.881273, 'ARCH_N1_K': 5.600589, 'ARCH_N1_BIAS': 0.376491, 'ARCH_N1_GAIN': -0.207841, 'ARCH_N2_K': 5.273739, 'ARCH_N2_BIAS': -0.846797, 'ARCH_N2_GAIN': -1.5, 'ARCH_N3_ON': 0.908002, 'ARCH_N3_BIAS': -0.530899, 'ARCH_N4_ON': 0.881037, 'ARCH_N4_A': 11, 'ARCH_N4_B': 19, 'ARCH_N4_K': 4.32938, 'ARCH_N4_BIAS': -1.749388, 'ARCH_N4_GAIN': 0.671972, 'ARCH_N5_ON': 0.899079, 'ARCH_N5_OP': 3, 'ARCH_N5_K': 3.031243, 'ARCH_N5_BIAS': -0.475885, 'ARCH_N5_GAIN': 1.5, 'ARCH_N6_ON': 1, 'ARCH_N6_K': 3.788339, 'ARCH_N6_BIAS': 1.443752, 'ARCH_N6_GAIN': 0.30418, 'ARCH_N7_OP': 3, 'ARCH_N7_A': 3, 'ARCH_N7_K': 0.2, 'ARCH_N7_BIAS': -0.149986, 'ARCH_N7_TARGET': 13, 'ARCH_N7_GAIN': 0.077489, 'ARCH_N8_ON': 0.392773, 'ARCH_N8_K': 2.055288, 'ARCH_N8_BIAS': -2.0, 'ARCH_N8_GAIN': 0.565551, 'ARCH_N9_ON': 0.473695, 'ARCH_N9_K': 0.2, 'ARCH_N9_BIAS': 0.146034, 'ARCH_N9_GAIN': 1.5, 'ARCH_N10_ON': 0.740026, 'ARCH_N10_OP': 4, 'ARCH_N10_K': 1.164854, 'ARCH_N10_BIAS': 0.0, 'ARCH_N10_GAIN': -1.315233, 'ARCH_N11_ON': 1, 'ARCH_N11_OP': 3, 'ARCH_N11_A': 32, 'ARCH_N11_K': 0.611716, 'ARCH_N11_BIAS': -0.922624, 'ARCH_N11_TARGET': 5, 'ARCH_N11_GAIN': -1.297104, 'ARCH_N12_ON': 0.670229, 'ARCH_N12_A': 23, 'ARCH_N12_K': 0.297369, 'ARCH_N12_BIAS': -0.229878, 'ARCH_N12_TARGET': 11, 'ARCH_N12_GAIN': -0.689532, 'ARCH_N13_A': 12, 'ARCH_N13_K': 0.2, 'ARCH_N13_BIAS': -1.357616, 'ARCH_N13_TARGET': 11, 'ARCH_N13_GAIN': 0.393046, 'ARCH_N14_ON': 0.689713, 'ARCH_N14_A': 12, 'ARCH_N14_K': 1.0, 'ARCH_N14_BIAS': 0.07889, 'ARCH_N14_GAIN': -0.043515, 'ARCH_N15_ON': 0.927686, 'ARCH_N15_OP': 0, 'ARCH_N15_A': 25, 'ARCH_N15_K': 1.848973, 'ARCH_N15_BIAS': -0.67433, 'ARCH_N15_GAIN': -0.731979}, 3: {'LA_VIRUS': 1, 'LA_MISS': 1, 'VIRUS_FEAST_CLEAR': 1.101278, 'FEAST_MIN_MASS': 4, 'W_VIRUS_FEAST': 1.738369, 'CYCLE_MIN_MASS': 52.674563, 'CYCLE_THREAT_CLEAR': 9.075971, 'VIRUS_FEAST_FALLOFF': 0.2, 'CORNER_SKIP_ON': 1, 'CORNER_TUCK': 0.579234, 'W_FRAG_HUNT': 0.000475, 'WEALTH_START': 40, 'CAMP_MAX_MASS': 64.11261, 'VIRUS_SLOT_EXP': 0.54949, 'VULN_EAT_MARGIN': 1.129965, 'VULN_MAX_BANK_RISK': 53.804177, 'ARCH_AUTHORITY': 0.35, 'ARCH_SPLIT_THRESHOLD': 0.747962, 'ARCH_N0_ON': 0.29276, 'ARCH_N0_K': 2.473963, 'ARCH_N0_GAIN': -1.156409, 'ARCH_N1_ON': 0.484663, 'ARCH_N1_B': 0, 'ARCH_N1_K': 3.393078, 'ARCH_N1_BIAS': 1.425538, 'ARCH_N1_TARGET': 3.314997, 'ARCH_N1_GAIN': -0.968613, 'ARCH_N2_ON': 0.805108, 'ARCH_N2_K': 5.832763, 'ARCH_N2_BIAS': -1.333683, 'ARCH_N2_GAIN': -1.357166, 'ARCH_N3_ON': 1, 'ARCH_N3_K': 2.617759, 'ARCH_N3_BIAS': 1.243398, 'ARCH_N3_GAIN': 0.169738, 'ARCH_N4_ON': 0.401578, 'ARCH_N4_OP': 5.040563, 'ARCH_N4_A': 2.816437, 'ARCH_N4_B': 19.0, 'ARCH_N4_K': 6.0, 'ARCH_N4_BIAS': 2.0, 'ARCH_N4_GAIN': -0.39939, 'ARCH_N5_ON': 0.445368, 'ARCH_N5_OP': 0.224776, 'ARCH_N5_A': 20.726075, 'ARCH_N5_B': 19.388488, 'ARCH_N5_K': 0.2, 'ARCH_N5_BIAS': 0.875769, 'ARCH_N6_ON': 1, 'ARCH_N6_A': 18.968024, 'ARCH_N6_K': 2.255134, 'ARCH_N6_BIAS': 1.959056, 'ARCH_N7_ON': 0.418661, 'ARCH_N7_OP': 4.011142, 'ARCH_N7_B': 20.490962, 'ARCH_N7_K': 4.477788, 'ARCH_N7_BIAS': 1.69194, 'ARCH_N7_TARGET': 2.0, 'ARCH_N7_GAIN': 0.092921, 'ARCH_N8_OP': 3.370796, 'ARCH_N8_A': 12.83159, 'ARCH_N8_K': 6.0, 'ARCH_N8_BIAS': -1.899372, 'ARCH_N8_TARGET': 10.90706, 'ARCH_N9_ON': 0.94271, 'ARCH_N9_OP': 2.974285, 'ARCH_N9_K': 1.153498, 'ARCH_N9_BIAS': -1.027569, 'ARCH_N9_GAIN': -0.477608, 'ARCH_N10_ON': 0.80031, 'ARCH_N10_K': 4.858743, 'ARCH_N10_BIAS': -1.865292, 'ARCH_N10_TARGET': 1.495992, 'ARCH_N10_GAIN': 1.135829, 'ARCH_N11_ON': 0.831101, 'ARCH_N11_OP': 0.272164, 'ARCH_N11_A': 32, 'ARCH_N11_K': 0.2, 'ARCH_N11_BIAS': -0.949849, 'ARCH_N12_ON': 0.751594, 'ARCH_N12_A': 12.795302, 'ARCH_N12_B': 16.131396, 'ARCH_N12_K': 3.240686, 'ARCH_N12_BIAS': 0.453743, 'ARCH_N12_TARGET': 9.251398, 'ARCH_N12_GAIN': -1.5, 'ARCH_N13_A': 12.155179, 'ARCH_N13_K': 3.720425, 'ARCH_N13_BIAS': 1.324063, 'ARCH_N13_TARGET': 11.0, 'ARCH_N13_GAIN': 0.297635, 'ARCH_N14_A': 10.832395, 'ARCH_N14_K': 0.2, 'ARCH_N14_GAIN': 0.009336, 'ARCH_N15_ON': 0.505479, 'ARCH_N15_OP': 4.476207, 'ARCH_N15_K': 0.2, 'ARCH_N15_TARGET': 3.465028, 'ARCH_N15_GAIN': 1.012664}, 7: {'LOOKAHEAD_ON': 0.0, 'LA_VIRUS': 1.0, 'LA_MISS': 1.0, 'VIRUS_FEAST_CLEAR': 3.46409, 'FEAST_MIN_MASS': 4.0, 'W_VIRUS_FEAST': 1.08512, 'CYCLE_MIN_MASS': 48.11, 'CYCLE_THREAT_CLEAR': 2, 'VIRUS_FEAST_FALLOFF': 0.491904, 'CORNER_SKIP_ON': 0.8142, 'CORNER_TUCK': 0.654277, 'CORNER_VETO_TICKS': 15.0, 'WEALTH_START': 40.0, 'CAMP_MAX_MASS': 39.278394, 'VIRUS_SLOT_EXP': 0.082816, 'VULN_MAX_BANK_RISK': 50.0, 'ARCH_AUTHORITY': 0.804788, 'ARCH_SPLIT_THRESHOLD': 0.760588, 'ARCH_MAX_ACTIVE': 16.0, 'ARCH_N0_ON': 0.607399, 'ARCH_N0_K': 0.229265, 'ARCH_N0_GAIN': -0.355172, 'ARCH_N1_ON': 1, 'ARCH_N1_K': 3.879782, 'ARCH_N1_BIAS': -1.287969, 'ARCH_N1_GAIN': -0.943489, 'ARCH_N2_ON': 0.975575, 'ARCH_N2_BIAS': 0.272446, 'ARCH_N2_GAIN': -1.5, 'ARCH_N3_ON': 0.55562, 'ARCH_N3_OP': 3.0, 'ARCH_N3_A': 16.0, 'ARCH_N3_B': 20.0, 'ARCH_N3_K': 4.839408, 'ARCH_N3_BIAS': -0.406129, 'ARCH_N3_TARGET': 13, 'ARCH_N3_GAIN': 0.733917, 'ARCH_N4_ON': 0.70507, 'ARCH_N4_OP': 6.0, 'ARCH_N4_A': 16.0, 'ARCH_N4_B': 0, 'ARCH_N4_K': 4.012227, 'ARCH_N4_BIAS': -1.982949, 'ARCH_N4_TARGET': 1.0, 'ARCH_N4_GAIN': 1.102278, 'ARCH_N5_ON': 1, 'ARCH_N5_OP': 6.0, 'ARCH_N5_A': 16.0, 'ARCH_N5_B': 0, 'ARCH_N5_K': 1.959254, 'ARCH_N5_BIAS': -1.461069, 'ARCH_N5_TARGET': 10.0, 'ARCH_N5_GAIN': 0.556753, 'ARCH_N6_ON': 1, 'ARCH_N6_OP': 6.0, 'ARCH_N6_A': 16.0, 'ARCH_N6_K': 3.9, 'ARCH_N6_BIAS': -1.366632, 'ARCH_N6_TARGET': 11.0, 'ARCH_N6_GAIN': -0.111446, 'ARCH_N7_ON': 0.540798, 'ARCH_N7_OP': 10, 'ARCH_N7_A': 16.0, 'ARCH_N7_B': 0, 'ARCH_N7_K': 0.2, 'ARCH_N7_BIAS': -1.813776, 'ARCH_N7_GAIN': -0.08562, 'ARCH_N8_ON': 1, 'ARCH_N8_OP': 10, 'ARCH_N8_A': 16.0, 'ARCH_N8_B': 0, 'ARCH_N8_K': 1.762588, 'ARCH_N8_BIAS': 0.73723, 'ARCH_N8_TARGET': 10.0, 'ARCH_N8_GAIN': 0.169816, 'ARCH_N9_ON': 1, 'ARCH_N9_OP': 6.0, 'ARCH_N9_A': 10.0, 'ARCH_N9_K': 1.835598, 'ARCH_N9_BIAS': 0.0, 'ARCH_N9_GAIN': 0.126767, 'ARCH_N10_ON': 1, 'ARCH_N10_OP': 3.0, 'ARCH_N10_A': 10.0, 'ARCH_N10_B': 14.0, 'ARCH_N10_K': 0.2, 'ARCH_N10_BIAS': 0.0, 'ARCH_N10_TARGET': 10.0, 'ARCH_N10_GAIN': 1.030931, 'ARCH_N11_ON': 1, 'ARCH_N11_OP': 3.0, 'ARCH_N11_A': 10.0, 'ARCH_N11_B': 14.0, 'ARCH_N11_K': 0.2, 'ARCH_N11_BIAS': 0.0, 'ARCH_N11_TARGET': 11.0, 'ARCH_N11_GAIN': -0.30688, 'ARCH_N12_ON': 1, 'ARCH_N12_A': 13.0, 'ARCH_N12_B': 20.0, 'ARCH_N12_K': 1.0, 'ARCH_N12_BIAS': 0.0, 'ARCH_N12_TARGET': 9.0, 'ARCH_N12_GAIN': 0.5, 'ARCH_N13_A': 12.0, 'ARCH_N13_B': 6.0, 'ARCH_N13_K': 1.779661, 'ARCH_N13_BIAS': -0.472114, 'ARCH_N13_TARGET': 13, 'ARCH_N13_GAIN': -0.408067, 'ARCH_N14_ON': 0.998518, 'ARCH_N14_OP': 6.0, 'ARCH_N14_A': 12.0, 'ARCH_N14_B': 10.0, 'ARCH_N14_K': 0.2, 'ARCH_N14_BIAS': -2.0, 'ARCH_N14_GAIN': -0.970631, 'ARCH_N15_ON': 1, 'ARCH_N15_OP': 6.0, 'ARCH_N15_A': 19.0, 'ARCH_N15_K': 5.803511, 'ARCH_N15_TARGET': 9.0, 'ARCH_N15_GAIN': -0.358902}}
...
ELITE_TEAM_IDS = (5, 15, 1, 9, 73, 37, 49)          # empty in gym -> tally code never runs
