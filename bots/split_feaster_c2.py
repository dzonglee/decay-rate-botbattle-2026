...
CONFIG = {
    ...
    "CYCLE_MIN_MASS": 30.0,        # total mass before cycling (halves must stay viable); bounds (4,40)
    "CYCLE_THREAT_CLEAR": 28.0,   # no lethal threat within this dist to cycle-split; bounds (2,25)
}
