...
CONFIG = {
    ...
    "CYCLE_MIN_MASS": 50,       # only cycle once BIG (don't fragment a small bank); bounds (4,40)
    "CYCLE_THREAT_CLEAR": 5,   # only cycle when threats are FAR (avoid deaths-while-fragmented); bounds (2,30)
    ...
    "CYCLE_TARGET_BLOBS": 6,   # cycle split ceiling (was 16)
