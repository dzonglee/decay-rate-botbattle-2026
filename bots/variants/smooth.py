"""
SYNCS Bot Battle 2026 — potential-field bot, VELOCITY-SMOOTHING variant.

Identical to my_bot.py except Tracker keeps an EMA of enemy velocities
(VEL_EMA_ALPHA) instead of raw single-frame deltas, steadying the
LEAD_TICKS prediction that both fleeing and chasing rely on.
...
CONFIG = {
    ...
    "VEL_EMA_ALPHA": 0.3,    # velocity EMA weight for the newest frame delta
    ...
    def update(self, blobs, my_player_id: int) -> None:
        ...
        for b in blobs:
            ...
            if key in self._last:
                ...
                # EMA smoothing: raw single-frame deltas are noisy and made
                # the intercept variant jittery; blend with history instead
