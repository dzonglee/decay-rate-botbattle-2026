...
CONFIG = {
    ...
    "THREAT_PANIC_DIST": 1.4499,
    "THREAT_PANIC_MULT": 0.026,
    "THREAT_IGNORE_DIST": 18.5502,
    "SPLIT_REACH": 51.3259,
    "W_SPLIT_ZONE": 0.1956,
    "WALL_MARGIN": 0.0072,
    "FRESH_MASS": 1.5474,
    "FRESH_CAUTION": 0.0044,
    "VETO_ENABLED": False,
    "VETO_MARGIN": 0.8447,
    "VETO_HORIZON": 4.8383,
    "VETO_SOFT_MASS": 0.9425,
    "LOCK_ENABLED": False,
    "LOCK_MIN_VALUE": 0.4592,
    "LOCK_TICKS_MAX": 20,
    ...
    "SPLIT_RUN_MAX_MASS": 0.0015,
    "SPLIT_RUN_TRIGGER": 0.0107,
    "EAT_RATIO": 1.2,
    "SAFETY_RATIO": 1.3777,
    "LEAD_TICKS": 1.5904,
    "LUNGE_ALARM_DIST": 0.0087,
    ...
    "CYCLE_THREAT_CLEAR": 22.5376,   # only cycle when threats are FAR (avoid deaths-while-fragmented); bounds (2,30)
    ...
    "HUNTER_AVOID_MULT": 2.25,     # virus-avoid radius mult when hunter near (was 1.5)
    "HUNTER_REPEL_MULT": 2.3017,     # virus repulsion mult when hunter near (was 2.0)
    "WALL_ESC_MARGIN_MULT": 1.0032,  # wall-escape activation margin (was 1.2)
    "WALL_ESC_NUDGE": 0.1647,        # outward nudge strength (was 0.2)
    "LUNGE_DISC_FRAC": 1.3447,       # deep-disc panic fraction (was 0.9)
    "SPLIT_ALIGN_MIN": 0.5073,       # prey-lunge alignment gate (was 0.7)
    "DEATH_COST_SCALE": 12.5,     # bank-size fear scaling divisor (was 25)
    "VIRUS_FEAST_FALLOFF": 1.0739,   # feast attraction falloff exponent (was 1/d)
    ...
    "W_MERGE_IDLE": 0.2491,          # 0=off; regroup when fragmented + no viruses visible
    # ORGAN: map positioning (center vs edge preference; evolution picks sign)
    "W_CENTER": 0.0668,              # 0=off; + seeks center, - seeks edges
    ...
    "W_AGGRO": 1.0498,               # extra threat weight vs measured aggressors
    ...
    "W_GRUDGE": 0.0405,              # 0=off; extra threat weight vs players who ate our blobs
    ...
    "W_RANK_AGGRO": 0.1809,          # 0=off; prey mult when trailing the visible field
    ...
    "PROF_FEAST_BOLD": 0.2234,         # virus-feast/cycle boldness when no ELITE within PROF_RADIUS
    # ===== OMNI-2.1 corner refuge (gate = weight > 0) =====
    "W_CORNER_REFUGE": 0.1583,         # when hunted by an uncatchable-for-us giant: tuck into ITS unreachable corner
    "AGGRO_DECAY": 0.9,
}
