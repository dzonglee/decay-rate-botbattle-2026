"""
split_feaster_v3_m50 - v3 + CYCLE_MIN_MASS=50. TWO-PHASE (accumulate then feast). Below PHASE_MASS=45: food x3,
...
CONFIG = {
    ...
    "CYCLE_MIN_MASS": 50.0,       # v3_m50: accumulate to 50 before cycling (evolution's discovery)
