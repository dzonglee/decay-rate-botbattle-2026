...
CONFIG = {
    ...
    "ARCH_N0_K": 1.96857,
    "ARCH_N0_BIAS": 0.139514,
    "ARCH_N0_TARGET": 8,   # prey channel logit
    "ARCH_N0_GAIN": -0.53382,
    ...
    "ARCH_N1_B": 15,        # wealth
    "ARCH_N1_K": 4.29402,
    "ARCH_N1_BIAS": 0.615908,
    "ARCH_N1_TARGET": 3,   # escape channel logit
    "ARCH_N1_GAIN": -1.25489,

    "ARCH_N2_ON": 1,
    "ARCH_N2_OP": 10,
    "ARCH_N2_A": 2,       # feast_ready
    "ARCH_N2_B": 5,        # threat_pressure
    "ARCH_N2_K": 0.653789,
    "ARCH_N2_BIAS": 1.11606,
    "ARCH_N2_TARGET": 5,   # guarded ordinary split vote
    "ARCH_N2_GAIN": -0.715062,
    ...
    "ARCH_N3_B": 14,
    "ARCH_N3_K": 1.81563,
    "ARCH_N3_BIAS": -0.344869,
    "ARCH_N3_TARGET": 2,
    "ARCH_N3_GAIN": -1.44803,
    ...
    for own in my_blobs:                                  # explicit attacker blob
        ...
        for owner, blobs in by_owner.items():
            for t in blobs:
                ...
                if half_m < t_m * CONFIG["EAT_RATIO"] * CONFIG["VULN_EAT_MARGIN"]:
                    continue
