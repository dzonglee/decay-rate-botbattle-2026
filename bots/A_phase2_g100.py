...
CONFIG = {
    ...
    "HUNTER_AVOID_MULT": 0.748049,     # virus-avoid radius mult when hunter near (was 1.5)
    "HUNTER_REPEL_MULT": 1.98308,     # virus repulsion mult when hunter near (was 2.0)
