...
CONFIG = {
    ...
    "ENVELOPE_MARGIN": 0.5,      # extra padding on every kill envelope
    "CHASE_HORIZON": 9.0,       # ticks ahead we must stay out of chase envelopes
    "PANIC_ENTER": 0.8,          # FLEE if any envelope boundary within this margin
    "SAFETY_RATIO": 1.12,        # near-edible counts as threat

    # --- bank / risk appetite ---
    "BANK_REF_MASS": 60.0,       # risk aversion doubles around this bank size
    "LATE_GAME_FRAC": 0.85,      # after this fraction of rounds, defence hardens
    "LATE_MARGIN_MULT": 1.3,     # envelope padding multiplier late game
    "FRESH_MASS": 2.0,           # below this we are expendable: be bold
    "FRESH_BOLD": 0.5,           # risk multiplier while fresh (<1 = braver)

    # --- hunting ---
    "HUNT_VALUE_MIN": 1.0,       # ignore prey worth less mass than this
    ...
    "SPLIT_MAX_MASS": 50.0,      # never lunge above this bank (protect the score)
    ...
    "W_VIRUS_FOOD": 30.0,        # virus = 67 pellets; dominant safe income
