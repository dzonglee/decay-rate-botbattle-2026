...
CONFIG_QUALIFY = {
    ...
    "CORNER_SKIP_ON": 1,        # >0.5 on; bounds (0,1). Hard-ON fleet-wide 2026-07-13:
    ...
    "CORNER_VETO_TICKS": 15,       # sticky veto: uncatchable corner target is blacklisted
    ...
    "CAMP_MAX_MASS": 20,        # too rich to camp (banking dominates)
    ...
    "VIRUS_SLOT_EXP": 0.0828159,        # 0=off; feast force *= (blobs/16)^exp
    ...
    "VULN_MAX_BANK_RISK": 50,    # never fire while wealthy (bank is the score)
    ...
    "ARCH_ON": 1,
    "ARCH_AUTHORITY": 0.619528,       # graph share of final steering; evolve in [0.35, 1.0]
    "ARCH_MIN_AUTHORITY": 0.35,   # prevents selection solving architecture by silencing it
    "ARCH_SPLIT_THRESHOLD": 0.624725,
    ...
    "ARCH_N0_K": 0.2,
    "ARCH_N0_BIAS": -0.920143,
    "ARCH_N0_TARGET": 4,   # prey channel logit
    "ARCH_N0_GAIN": -0.355172,
    ...
    "ARCH_N1_B": 3,        # wealth
    "ARCH_N1_K": 6,
    "ARCH_N1_BIAS": -1.32212,
    "ARCH_N1_TARGET": 4,   # escape channel logit
    "ARCH_N1_GAIN": -1.10631,
    ...
    "ARCH_N3_B": 12,
    "ARCH_N3_K": 0.2,
    "ARCH_N3_BIAS": -1.20388,
    "ARCH_N3_TARGET": 1,
    "ARCH_N3_GAIN": -1.5,

    "ARCH_N4_ON": 0.0483706,
    "ARCH_N4_OP": 0,
    "ARCH_N4_A": 0,
    "ARCH_N4_B": 0,
    "ARCH_N4_K": 1.94729,
    "ARCH_N4_BIAS": 1.07099,
    "ARCH_N4_TARGET": 0,
    "ARCH_N4_GAIN": 0.825563,
    ...
    "ARCH_N5_B": 0,
    "ARCH_N5_K": 1,
    "ARCH_N5_BIAS": -0.874965,
    "ARCH_N5_TARGET": 0,
    "ARCH_N5_GAIN": 1.28029,
    ...
    "ARCH_N6_B": 26,
    "ARCH_N6_K": 1.60789,
    "ARCH_N6_BIAS": 0.0666716,
    "ARCH_N6_TARGET": 0,
    "ARCH_N6_GAIN": 0.0695224,
    ...
    "ARCH_N7_B": 0,
    "ARCH_N7_K": 1,
    "ARCH_N7_BIAS": 0.0290938,
    "ARCH_N7_TARGET": 0,
    "ARCH_N7_GAIN": -1.22333,
    ...
    "ARCH_N9_B": 0,
    "ARCH_N9_K": 3.60144,
    "ARCH_N9_BIAS": 1.10626,
    "ARCH_N9_TARGET": 0,
    "ARCH_N9_GAIN": 0.21384,

    "ARCH_N10_ON": 0.312885,
    "ARCH_N10_OP": 0,
    "ARCH_N10_A": 0,
    "ARCH_N10_B": 0,
    "ARCH_N10_K": 0.672936,
    ...
    "ARCH_N11_BIAS": 0,
    "ARCH_N11_TARGET": 0,
    "ARCH_N11_GAIN": -0.816183,
    "ARCH_N12_ON": 0.495057,
    "ARCH_N12_OP": 0,
    "ARCH_N12_A": 0,
    "ARCH_N12_B": 0,
    "ARCH_N12_K": 1.0316,
    "ARCH_N12_BIAS": 0,
    "ARCH_N12_TARGET": 0,
    "ARCH_N12_GAIN": -0.0670459,
    "ARCH_N13_ON": 0,
    "ARCH_N13_OP": 0,
    "ARCH_N13_A": 0,
    "ARCH_N13_B": 0,
    "ARCH_N13_K": 2.78098,
    "ARCH_N13_BIAS": -0.273987,
    "ARCH_N13_TARGET": 0,
    "ARCH_N13_GAIN": 0.4612,
    "ARCH_N14_ON": 0.192747,
    "ARCH_N14_OP": 0,
    "ARCH_N14_A": 0,
    "ARCH_N14_B": 0,
    "ARCH_N14_K": 1.0639,
    "ARCH_N14_BIAS": -0.0849529,
    "ARCH_N14_TARGET": 0,
    "ARCH_N14_GAIN": 1.5,
    "ARCH_N15_ON": 0,
    "ARCH_N15_OP": 0,
    ...
    "ARCH_N15_B": 0,
    "ARCH_N15_K": 0.2,
    "ARCH_N15_BIAS": -1.19216,
    "ARCH_N15_TARGET": 0,
    "ARCH_N15_GAIN": -0.234711,
...
CONFIG_FINALS = {
    ...
    # rather than merely adding small residual forces.
    "ARCH_ON": 1,
    "ARCH_AUTHORITY": 0.739528,       # graph share of final steering; evolve in [0.35, 1.0]
    "ARCH_MIN_AUTHORITY": 0.35,   # prevents selection solving architecture by silencing it
    "ARCH_SPLIT_THRESHOLD": 0.705725,
    "ARCH_SPLIT_THREAT_CLEAR": 12,
    "ARCH_MAX_ACTIVE": 16,
    # Baseline channel logits. exp(logit) becomes the primitive's positive weight.
    # The incumbent channel keeps the mature controller available, but does not dominate.
    ...
    "ARCH_N15_BIAS": -1.35,
    "ARCH_N15_TARGET": 6,
    "ARCH_N15_GAIN": 0.25773,

}

# ---- time-gated selection (fails safe to QUALIFY) ----
_FINALS_CUTOVER_UTC = "2026-07-19T13:00:00"
try:
