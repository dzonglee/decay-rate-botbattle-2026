...
CONFIG = {
    ...
    "CYCLE_MIN_MASS": 45,       # only cycle once BIG (don't fragment a small bank); bounds (4,40)
    "CYCLE_THREAT_CLEAR": 4,   # only cycle when threats are FAR (avoid deaths-while-fragmented); bounds (2,30)
    ...
    "CYCLE_TARGET_BLOBS": 10,   # cycle split ceiling (was 16)
