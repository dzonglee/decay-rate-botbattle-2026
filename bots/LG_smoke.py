...
CONFIG = {
    ...
    "LG_THRESH": 3,             # opportunity-minus-risk break-even point
    "LG_SHARP": 0.35,             # sigmoid sharpness
    "LG_RADIUS": 16,            # local scan radius for harvest/risk scoring
    "LG_PREY_HIGH": 2,          # prey+feast force mult at full opportunity (1.0=neutral)
