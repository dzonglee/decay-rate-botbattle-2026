...
CONFIG = {
    ...
    "ARCH_ON": 1,
    "ARCH_AUTHORITY": 0.645035,       # graph share of final steering; evolve in [0.35, 1.0]
    "ARCH_MIN_AUTHORITY": 0.35,   # prevents selection solving architecture by silencing it
    "ARCH_SPLIT_THRESHOLD": 0.696864,
    ...
    "ARCH_BASE_FOOD": -1.2,
    "ARCH_BASE_PREY": 0.25,
    "ARCH_BASE_ESCAPE": 0.45,
    "ARCH_BASE_VIRUS": -0.15,
    "ARCH_BASE_CENTER": -1.4,
    "ARCH_BASE_INCUMBENT": 0,
    ...
    "ARCH_N1_B": 9,        # wealth
    "ARCH_N1_K": 2.16132,
    "ARCH_N1_BIAS": 0.150877,
    "ARCH_N1_TARGET": 2,   # escape channel logit
    "ARCH_N1_GAIN": 0.0328794,

    "ARCH_N2_ON": 1,
    "ARCH_N2_OP": 2,
    "ARCH_N2_A": 6,       # feast_ready
    "ARCH_N2_B": 5,        # threat_pressure
    "ARCH_N2_K": 0.574669,
    "ARCH_N2_BIAS": 0.0513908,
    "ARCH_N2_TARGET": 6,   # guarded ordinary split vote
    "ARCH_N2_GAIN": 1.05798,
