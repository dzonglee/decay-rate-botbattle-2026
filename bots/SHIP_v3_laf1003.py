...
CONFIG = {
    ...
    "CYCLE_MIN_MASS": 52.6746,       # only cycle once BIG (don't fragment a small bank); bounds (4,40)
    "CYCLE_THREAT_CLEAR": 5.21053,   # only cycle when threats are FAR (avoid deaths-while-fragmented); bounds (2,30)
    ...
    "CAMP_MAX_MASS": 55.6131,        # too rich to camp (banking dominates)
    ...
    "VIRUS_SLOT_EXP": 0.54949,        # 0=off; feast force *= (blobs/16)^exp
    ...
    "ARCH_ON": 1,
    "ARCH_AUTHORITY": 0.49759,       # graph share of final steering; evolve in [0.35, 1.0]
    "ARCH_MIN_AUTHORITY": 0.35,   # prevents selection solving architecture by silencing it
    "ARCH_SPLIT_THRESHOLD": 0.54251,
    ...
    "ARCH_N0_K": 0.2,
    "ARCH_N0_BIAS": -1.36227,
    "ARCH_N0_TARGET": 4,   # prey channel logit
    "ARCH_N0_GAIN": 0.0300381,
    ...
    "ARCH_N1_B": 3,        # wealth
    "ARCH_N1_K": 5.84192,
    "ARCH_N1_BIAS": 0.461028,
    "ARCH_N1_TARGET": 4,   # escape channel logit
    "ARCH_N1_GAIN": -0.207841,
    ...
    "ARCH_N4_B": 19,
    "ARCH_N4_K": 4.32938,
    "ARCH_N4_BIAS": -1.74939,
    "ARCH_N4_TARGET": 5,
    "ARCH_N4_GAIN": 0.671972,
    ...
    "ARCH_N6_B": 0,
    "ARCH_N6_K": 3.78834,
    "ARCH_N6_BIAS": 1.44375,
    "ARCH_N6_TARGET": 9,
    "ARCH_N6_GAIN": 0.30418,
    ...
    "ARCH_N7_B": 19,
    "ARCH_N7_K": 0.2,
    "ARCH_N7_BIAS": -0.140369,
    "ARCH_N7_TARGET": 13,
    "ARCH_N7_GAIN": 0.0774889,
    ...
    "ARCH_N10_BIAS": 0,
    "ARCH_N10_TARGET": 3,
    "ARCH_N10_GAIN": -1.31523,
    "ARCH_N11_ON": 1,
    "ARCH_N11_OP": 3,
    "ARCH_N11_A": 28,
    "ARCH_N11_B": 6,
    "ARCH_N11_K": 0.611716,
    "ARCH_N11_BIAS": -0.922624,
    "ARCH_N11_TARGET": 5,
    "ARCH_N11_GAIN": -1.38829,
    "ARCH_N12_ON": 0.670423,
    "ARCH_N12_OP": 3,
    "ARCH_N12_A": 23,
    "ARCH_N12_B": 14,
    "ARCH_N12_K": 0.297369,
    "ARCH_N12_BIAS": -0.229878,
    "ARCH_N12_TARGET": 11,
    "ARCH_N12_GAIN": -0.603533,
    "ARCH_N13_ON": 1,
    "ARCH_N13_OP": 3,
    "ARCH_N13_A": 12,
    "ARCH_N13_B": 9,
    "ARCH_N13_K": 0.2,
    "ARCH_N13_BIAS": -1.35762,
    "ARCH_N13_TARGET": 11,
    "ARCH_N13_GAIN": 0.326053,
    "ARCH_N14_ON": 0.689713,
    "ARCH_N14_OP": 0,
    "ARCH_N14_A": 12,
    "ARCH_N14_B": 0,
    "ARCH_N14_K": 1,
    "ARCH_N14_BIAS": 0.0788905,
    "ARCH_N14_TARGET": 7,
    "ARCH_N14_GAIN": -0.0435148,
    "ARCH_N15_ON": 0.927686,
    "ARCH_N15_OP": 0,
    "ARCH_N15_A": 25,
    "ARCH_N15_B": 0,
    "ARCH_N15_K": 1.84897,
    "ARCH_N15_BIAS": -0.67433,
    "ARCH_N15_TARGET": 6,
