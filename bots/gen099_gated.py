"""
gen099_gated - one-gene gate restoration of gen099_i19.

i19's evolved SLOT_SAT~0.4 makes the feast posture always-on (blob count >=1
always satisfies the OR), nullifying FEAST_MIN_MASS=38.8. SLOT_SAT=16 restores
the mass gate: feast only above ~39 total mass - the measured profile of the
current apex (Washed CS 43% of consumptions at 40+; Engorgio feast@46 avg,
sub-751 era). Hypothesis: patient-feast matches the hardened meta; i19's early
shatters at 10-25 mass are the wound (3 of 4 fatal kills on us were mid-feast).
...
CONFIG = {
    ...
    "W_VIRUS_BIG": 139.712,
    "W_WALL": 0.133069,
    "W_REGROUP": 6.92114e-05,
    "FOOD_FALLOFF": 2.08326,
    "PREY_FALLOFF": 0.758792,
    "THREAT_FALLOFF": 0.11813,
    "THREAT_PANIC_DIST": 0.518593,
    "THREAT_PANIC_MULT": 0.541682,
    "THREAT_IGNORE_DIST": 26.7998,
    "SPLIT_REACH": 51.3259,
    "W_SPLIT_ZONE": 0.171302,
    "WALL_MARGIN": 0.194192,
    "FRESH_MASS": 1.44465,
    "FRESH_CAUTION": 0.0227042,
    "VETO_ENABLED": False,
    "VETO_MARGIN": 0.716318,
    "VETO_HORIZON": 2.58496,
    "VETO_SOFT_MASS": 3.2453,
    "LOCK_ENABLED": False,
    "LOCK_MIN_VALUE": 0.50008,
    "LOCK_TICKS_MAX": 185.032,
    "LOCK_ABANDON_T": 12.2652,
    "W_LOCK": 0.893155,
    "LOCK_THREAT_BREAK": 0.0856804,
    "LUNGE_DISC_PANIC": 0.795288,
    "SPLIT_RUN_ENABLED": False,
    "SPLIT_RUN_MAX_MASS": 0.00237922,
    "SPLIT_RUN_TRIGGER": 0.0324775,
    "EAT_RATIO": 1.2,
    "SAFETY_RATIO": 1.18,
    "LEAD_TICKS": 1.01936,
    "LUNGE_ALARM_DIST": 0.0681846,
    "W_LUNGE_ALARM": 0.336951,
    "SPLIT_ENABLED": True,
    "SPLIT_MAX_RANGE": 13.4753,
    "SPLIT_SAFETY_RATIO": 0.0101252,
    "SPLIT_MAX_BLOBS": 1.5628,
    "SPLIT_THREAT_CLEARANCE": 0.223454,
    "SPLIT_MIN_MASS": 2.0,
    "SPLIT_MAX_MASS": 120.256,
    "VIRUS_DANGER_MASS_RATIO": 1.2,
    "VIRUS_AVOID_DIST": 0.854988,
    "W_VIRUS_FOOD": 0.00145505,
    "VIRUS_FEAST_CLEAR": 7.18749,
    "BOOT_MASS": 0.402028,
    "BOOT_VIRUS_MULT": 0.636266,
    "BOOT_VIRUS_CLEAR": 3.21227,
    "FEAST_MIN_MASS": 38.8093,
    "FEAST_SLOT_SAT": 16.0,
    "W_VIRUS_FEAST": 4.16335,
}
